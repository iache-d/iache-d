...
- [`trayectoria_0_grados.py`](./Experiencias/Experiencia_1/trayectoria_0_grados.py): Lectura de datos a 0°, normalización de coordenadas, graficación de trayectorias y tendencia promedio.
- [`trayectoria_30_grados.py`](./Experiencias/Experiencia_1/trayectorias_0deg_promedio.py): Procesamiento de datos a 30°, ajuste cuadrático promedio y comparación con la curva teórica.
